...
//       nickName: ['', [Validators.pattern(/^[a-zA-Z._]{3,15}$/)]],
...
//           this.emailError = '* This email address is already registered.'; // Set the error message
//           this.signUpForm.get('email')?.setErrors({ 'duplicateEmail': true }); // Optionally mark the email field as invalid with a specific error
//         } else {
